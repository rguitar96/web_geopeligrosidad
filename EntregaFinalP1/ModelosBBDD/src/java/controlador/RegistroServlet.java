...
public class RegistroServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (modelodatos.registrarUsuario(u)) {
            Usuario uauth = u;

            response.sendRedirect("/ModelosBBDD/index.html");
            modelodatos.cerrarConexion();
        } else {
            session.setAttribute("error", "Login incorrecto");
            response.sendRedirect("/ModelosBBDD/error.jsp");
        }
    }
